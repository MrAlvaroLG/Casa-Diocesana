...
// Componente de icono para el ojo cerrado
const EyeClosedIcon = () => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 640 512" 
...
export default function Home() {
  ...
  return (
    <div className="w-dvw sm:w-lg">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl sm:text-2xl flex justify-center">
            Crear Cuenta
          </CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem className="md:h-10 md:text-base" value="Religiosa">
                    Religiosa
                  </SelectItem>
                  <SelectItem className="md:h-10 md:text-base" value="Religioso">
                    Religioso
                  </SelectItem>
                  <SelectItem className="md:h-10 md:text-base" value="Diacono">
                    Diacono
                  </SelectItem>
                  <SelectItem className="md:h-10 md:text-base" value="Sacerdote">
                    Sacerdote
                  </SelectItem>
                </SelectContent>
              </Select>
